...
try {Winget | Out-Null}
    ...
    Invoke-WebRequest -Uri https://aka.ms/Microsoft.VCLibs.x64.14.00.Desktop.appx -OutFile VCLibs.appx; Add-AppxPackage -Path .\VCLibs.appx; Remove-Item -Path .\VCLibs.appx
    Invoke-WebRequest -Uri https://github.com/microsoft/microsoft-ui-xaml/releases/download/v2.7.3/Microsoft.UI.Xaml.2.7.x64.appx -OutFile Xaml.appx; Add-AppxPackage -Path .\Xaml.appx; Remove-Item -Path .\Xaml.appx
